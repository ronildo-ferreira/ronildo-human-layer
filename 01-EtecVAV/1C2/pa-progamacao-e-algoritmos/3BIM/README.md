...
| M3 | Seminário | Apresentação do sistema. Dois alunos da turma A e dois da turma B irão apresentar o Sistema Lanchonete com todos as funcinalidade integradas. | 24/09/2026| | Os representates irão criar um repositório, público para o projeto. |
