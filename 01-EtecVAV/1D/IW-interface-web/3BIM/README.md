...
|--------|-----|-----|-----|-|-|
| M1 | Estudo de Caso|  Estudar: [BootStrap](https://github.com/Zaion-Alaric-Zanarelli/zaion-web-studio/blob/main/content/bootstrap/o-que-e-bootstrap.md). Montar uma página exemplo, aplicando bootstrap. Entraga: GitHub,na pasta da dupla. | 11/08/2026|[Exemplo](https://github.com/Zaion-Alaric-Zanarelli/zaion-web-studio/blob/main/activities/bootstrap/projeto-bootstrap-python.zip) | Fazer o download do exemplo |
| M2 | |  | | | |
