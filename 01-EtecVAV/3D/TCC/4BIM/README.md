# 📅 Cronograma de Entrega de Atividades (4 Bimestre)
- Turma: 3D
...
|--------|-----|-----|-----|-|-|
| M1 | Audiovisual | Materiais para apresentação do TCC (05/12/2026). No GitHub | 27/11/2026 | | |
| M2 | Seminário | Apresentação do TCC (Treinamento). Laboratório, um grupo por vez. | 27/11/2026| | |
| M3 | Feira TCC | Apresentação ao público (05/12/2026, Sábado)|05/12/2026||
| M4 | Portfólio| Análise do Github do grupo | 11/12/2026| | |
