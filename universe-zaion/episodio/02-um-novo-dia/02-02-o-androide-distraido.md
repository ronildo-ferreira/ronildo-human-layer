...
— Então, o que vamos fazer? — perguntou Kael.  
...
7. Criação de conta  
8. Integração Git + GitHub (push, pull, clone)  
9. Conclusão  
10. Referências  
...
6. Colaboração e desenvolvimento em equipe  
7. Git na prática (fluxo básico: add → commit → push)  
8. Exemplo simples de uso  
9. Considerações finais  
10. Referências  

— Evitem muito texto — continuou Zeta — priorizem tópicos, exemplos e organização visual.  

— Gostei — disse Zaion, olhando para Kael.  

— No tópico de GitHub, precisamos incluir também colaboração e desenvolvimento comunitário — completou Kael.  

— Anotado — respondeu Zeta.  

— E a **HQ?** — perguntou Kael.  
...
— Podemos usar IA como apoio para montar o roteiro e organizar os diálogos — completou.  
