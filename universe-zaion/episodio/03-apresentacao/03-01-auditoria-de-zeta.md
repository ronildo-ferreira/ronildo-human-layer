...
Zeta chegou ao centro de pesquisa no horário combinado.

Na recepção, pediram para aguardar.

---

Na sala de espera, ele observava a movimentação.

Por segurança, iniciou sua rotina de verificação.
...
Rotinas: estáveis.  
Memórias: íntegras.  
Simuladores comportamentais: dentro do esperado.

---

Acessando registros do acidente...
...
— Estão bem. Devem receber alta em poucas horas.
...
Zeta analisou seus registros internos.
...
Mais tarde, na unidade de recarga:

— Ativando sistema de recarga.  
— Sistema em suspensão.
...
Restabelecendo memórias...

---

Revisando diretrizes:

1. Proteger Zaion e Leo  
2. Manter discrição e segredo  
...
|[` < voltar `](../02-um-novo-dia/02-07-o-pesadelo-de-zeta.md)| [` avançar > `](03-02-a-visao-de-zeta.md)|
|--------|-----|
